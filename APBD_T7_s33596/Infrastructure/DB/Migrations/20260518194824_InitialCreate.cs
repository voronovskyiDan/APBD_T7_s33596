        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attribute = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Attribute", "FoundationDate", "FullName" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gaming Beast", 5, 24, 12.5 },
                    { 2, new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Workstation Pro", 3, 36, 10.199999999999999 },
                    { 3, new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Budget Build", 10, 12, 8.0 }
                });

            migrationBuilder.InsertData(
                table: "Components",
                columns: new[] { "Code", "ComponentManufacturerId", "ComponentManufacturersId", "ComponentTypeId", "Description", "Name" },
                values: new object[,]
                {
                    { "I9-14900K", null, 1, 1, "High-end Intel CPU", "Intel i9 14900K" },
                    { "R9-7950X", null, 2, 1, "High-end AMD CPU", "AMD Ryzen 9 7950X" },
                    { "RTX4090", null, 3, 2, "Top-tier GPU", "NVIDIA RTX 4090" }
                });
